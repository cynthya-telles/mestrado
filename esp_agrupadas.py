...
while True:  # Um loop que vai rodar até que se pressione a tecla "q"
    ...
    if keyboard.is_pressed('c'):  # Se pressionar a tecla a
        ...
        mixer.music.load("C:\\Users\\labvis\\Documents\\Dissertacao\\Mod_Esp\\Por_partes\\Agrupadas\\1.cat.mp3")  # Toca esse MP3
        mixer.music.play()
    ...
    if keyboard.is_pressed('l'):  # Se pressionar a tecla b
        ...
        mixer.music.load("C:\\Users\\labvis\\Documents\\Dissertacao\\Mod_Esp\\Por_partes\\Agrupadas\\2.legenda.mp3")  # Toca esse MP3
        mixer.music.play()
        time.sleep(0.5) # Isso aqui é só pra debouncing, evitar que cada tecla seja pressionada varias vezes enquanto não soltar a tecla
    ...
    if keyboard.is_pressed('y'):  # Se pressionar a tecla b
        ...
        mixer.music.load("C:\\Users\\labvis\\Documents\\Dissertacao\\Mod_Esp\\Por_partes\\Agrupadas\\3.eixo y.mp3")  # Toca esse MP3
        mixer.music.play()
        time.sleep(0.5)    
    ...
    if keyboard.is_pressed('x'):  # Se pressionar a tecla b
        ...
        mixer.music.load("C:\\Users\\labvis\\Documents\\Dissertacao\\Mod_Esp\\Por_partes\\Agrupadas\\4.eixo x.mp3")  # Toca esse MP3
        mixer.music.play()
        time.sleep(0.5)
    ...
    if keyboard.is_pressed('g'):  # Se pressionar a tecla b
        ...
        mixer.music.load("C:\\Users\\labvis\\Documents\\Dissertacao\\Mod_Esp\\Por_partes\\Agrupadas\\5.grupos_series.mp3")  # Toca esse MP3
        mixer.music.play()
        time.sleep(0.5)
    ...
    if keyboard.is_pressed('m'):  # Se pressionar a tecla b
        ...
        mixer.music.load("C:\\Users\\labvis\\Documents\\Dissertacao\\Mod_Esp\\Por_partes\\Agrupadas\\6.min_max.mp3")  # Toca esse MP3
        mixer.music.play()
        time.sleep(0.5)
    ...
    if keyboard.is_pressed('1'):  # Se pressionar a tecla b
        ...
        mixer.music.load("C:\\Users\\labvis\\Documents\\Dissertacao\\Mod_Esp\\Por_partes\\Agrupadas\\7.1.mp3")  # Toca esse MP3
        mixer.music.play()
        time.sleep(0.5)
    ...
    if keyboard.is_pressed('2'):  # Se pressionar a tecla b
        ...
        mixer.music.load("C:\\Users\\labvis\\Documents\\Dissertacao\\Mod_Esp\\Por_partes\\Agrupadas\\8.2.mp3")  # Toca esse MP3
        mixer.music.play()
        time.sleep(0.5)
    ...
    if keyboard.is_pressed('3'):  # Se pressionar a tecla b
        ...
        mixer.music.load("C:\\Users\\labvis\\Documents\\Dissertacao\\Mod_Esp\\Por_partes\\Agrupadas\\9.3.mp3")  # Toca esse MP3
        mixer.music.play()
        time.sleep(0.5)
    ...
    if keyboard.is_pressed('d'):  # Se pressionar a tecla b
        ...
        mixer.music.load("C:\\Users\\labvis\\Documents\\Dissertacao\\Mod_Esp\\Completo\\Agrupadas.mp3")  # Toca esse MP3
        mixer.music.play()
        time.sleep(0.5)
